...
class SiswaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'foto' => 'image|mimes:jpeg,png,jpg,gif|max:1024', // Adjust image validation as needed
        ]);
        ...
        // Update foto if a new file is provided
        if ($request->hasFile('foto')) {
            // Handle file upload logic, e.g., store the file and update the database field
